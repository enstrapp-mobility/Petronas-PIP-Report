sap.ui.define(["sap/ui/core/UIComponent", "sap/ui/Device", "ZEMT_AM_PIP_APP/model/models", "sap/ui/core/Core"], function(UIComponent, Device, models, Core) {
	jQuery.sap.require("sap.ui.core.format.DateFormat");
	jQuery.sap.require("sap.m.MessageBox");
	// for Loading Excel read libs
	/*jQuery.sap.require("ZEMT_AM_PIP_APP/libs/jszip");
	jQuery.sap.require("ZEMT_AM_PIP_APP/libs/xlsx");*/
	// For connect Local or inside SAP
	jQuery.sap.require("ZEMT_AM_PIP_APP/connection/connection");
	return UIComponent.extend("ZEMT_AM_PIP_APP.Component", {
		metadata: {
			manifest: "json"
		},
		init: function() {
